...
let students = [
    { id: 1, firstName: "Frasquito", lastName: "Koop", email: "fkoop0@ow.ly", gender: "Male", city: "Benzilan", averageGrade: 4, age: 33 },
...
const studentWithAverageGradeHigherThanThree = students
    .filter((s) => s.averageGrade > 3);
console.log(studentWithAverageGradeHigherThanThree);

// All female student names with an average grade of 5
const femaleStudentsWithAverageGradeOfFive = students
    .filter(s => s.gender === "Female" && s.averageGrade === 5)
    .map(s => `${s.firstName} ${s.lastName}`);
console.log(femaleStudentsWithAverageGradeOfFive);

// All male student full names who live in Skopje and are over 18 years old
const allMaleStudentsWhoLivesInSkopjeAndAreOlderThan18 = students
    .filter(s => s.city === "Skopje" && s.age >= 18);
console.log(allMaleStudentsWhoLivesInSkopjeAndAreOlderThan18);

// The average grades of all female students over the age of 24
const femaleStudentsOver24 = students
    .filter(s => s.gender === "Female" && s.age >= 24)
    .map(s => s.averageGrade);

const sum = femaleStudentsOver24.reduce((acc, grade) => acc + grade, 0);
let average = sum / femaleStudentsOver24.length;
console.log(average);

// All male students with a name starting with B and average grade over 2
const maleStudentsWithB = students
    .filter(s => s.gender === "Male" && s.firstName[0] === "B" && s.averageGrade > 2);
console.log(maleStudentsWithB);
